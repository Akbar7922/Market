...
@section('content')
                ...
                <a href="{{$slide->link}}">
                    <div>
                        <div class="home text-center">
                            <img src="{{asset('/asset/front/abzar/images/home-banner/'.$slide->pic)}}" alt=""
                                ...
                                <div class="row">
                                    <div class="slider-contain">
                                        <div style="margin-right: 100px">
                                            <h4>{{$slide->title}}</h4>
                                            <a href="{{$slide->link}}" class="btn btn-solid">خرید کنید </a>
                                        </div>
                                    </div>
                                </div>
                            </div>--}}
    ...
    <section class="full-banner parallax small-slider tools-parallax-product product_list_section">
        <img src="{{asset('asset/front/abzar/images/parallax/21.jpg')}}" alt="" class="bg-img blur-up lazyload">
        <div class="container">
                    ...
                    <div class="no-arrow" style="text-align: center">
                        @foreach($brands as $brand)
                            <div class="logo-block"
                                ...
                                <a href="#">
                                    <img class="img-brands" src="{{asset('image/brands/'.$brand->id . '.png')}}"
                                         alt="">
                                </a>
                            </div>
                        @endforeach
...
@section('modal')
                        ...
                        <div class="col-lg-6 rtl-text">
                            <div class="product-right">
                                ...
                                <div class="border-product">
                                    ...
                                    <p>اما تا ببینی این همه خطا از کجا نشأت می‌گیرد کسانی که لذت را متهم می‌کنند و درد
                                        را ستایش می‌کنند</p>
                                </div>
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-prepend">
                                                <button type="button" class="btn quantity-left-minus" data-type="minus"
                                                        data-field=""> <i class="ti-angle-right"></i>
                                                </button>
                                            </span>
                                ...
                                <div class="product-buttons">
                                    <a href="#" class="btn btn-solid">اضافه کردن به سبد</a>
                                    <a href="#" class="btn btn-solid">دیدن جزئیات </a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- اضافه کردن به سبد  modal popup start-->
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="img-fluid blur-up lazyload pro-img"
                                                 src="/asset/front/abzar/images/fashion/product/43.jpg" alt="">
                                        </a>
                                        <div class="media-body align-self-center text-center">
                                            ...
                                            <div class="upsell_payment">
                                                <img src="/asset/front/abzar/images/payment_cart.png"
                                        ...
                                        <div class="row" id="upsell_product">
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="/asset/front/abzar/images/fashion/product/1.jpg"
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="/asset/front/abzar/images/fashion/product/34.jpg"
                                                                 class="img-fluid blur-up lazyload mb-1"
                                                                 alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="/asset/front/abzar/images/fashion/product/13.jpg"
                                                                 class="img-fluid blur-up lazyload mb-1"
                                                                 alt="cotton top">
                                                        </a>
                                                    </div>
                                            ...
                                            <div class="product-box col-sm-3 col-6">
                                                <div class="img-wrapper">
                                                    <div class="front">
                                                        <a href="#">
                                                            <img src="/asset/front/abzar/images/fashion/product/19.jpg"
                                                                 class="img-fluid blur-up lazyload mb-1"
                                                                 alt="cotton top">
                                                        </a>
                                                    </div>
    ...
    <!-- اضافه کردن به سبد  modal popup end-->
