                            ...
                            <form class="form-header">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-solid" id="search_btn"><i
                                                class="fa fa-search"></i>جستجو کردن
                                        </button>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <li>
                                            <label for="category{{$category->id}}">
                                                <input type="checkbox" name="category" id="category{{$category->id}}"
                                                       value="{{$category->id}}"
                                                        @if(request()->has('category') && request()->get('category')==$category->id) checked @endif>
                                                {{$category->name}}
                                            </label>
                                        </li>
                                    @endforeach
                                        ...
                                        <li>
                                            <label for="brand{{$brand->id}}">
                                                <input type="checkbox" name="brand" id="brand{{$brand->id}}"
                                                       value="{{$brand->id}}"
                                                       @if(request()->has('brand') && request()->get('brand')==$brand->id) checked @endif>
                                                {{$brand->name}}
                                            </label>
                                        </li>
                                    @endforeach
