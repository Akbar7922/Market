            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="product-order">
                            ...
                            @foreach($shopOrder->shopOrderProducts as $product)
                                <div class="row product-order-detail">
                                    ...
                                    <div class="col-3 order_detail">
                                        <div>
                                            <h4>مجموع </h4>
                                            <h5>{{number_format($product->price * $product->count , 0)}}</h5>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="total-sec">
                            <ul>
                                <li>جمع <span>{{number_format($order->price , 0)}}</span></li>
                                <li>حمل و نقل <span>{{number_format($order->send_price , 0)}}</span></li>
                            </ul>
                        </div>
                        <div class="final-total">
                            <h3>جمع <span>{{number_format($order->price + $order->send_price , 0)}}</span></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
