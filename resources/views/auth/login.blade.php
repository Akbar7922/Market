                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="top-profile-tab" data-bs-toggle="tab"
                                       ...
                                       aria-selected="true"><span class="icon-user me-2"></span>ورود</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-top-tab" data-bs-toggle="tab" href="#top-contact"
                                       role="tab" aria-controls="top-contact" aria-selected="false"><span
                                            class="icon-unlock me-2"></span>ثبت نام</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="top-tabContent">
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel"
                                    ...
                                    @endif
                                    <form id="loginForm" class="form-horizontal auth-form" action="{{route('login')}}"
                                          method="post">
                                        @csrf
                                        <div class="form-group">
                                            <input required="" name="mobile" type="text" class="form-control"
                                                   placeholder="شماره موبایل" maxlength="11" minlength="11"
                                                   id="mobile_login"/>
                                ...
                                <div class="tab-pane fade" id="top-contact" role="tabpanel"
                                    ...
                                    <div class="form-group">
                                        <button id="sendCode" data-link="{{route('sendCode')}}"
                                    ...
                                    <div class="form-button">
                                        <button id="registerBtn" data-link="{{route('validateCode')}}"
                                                class="btn btn-primary" type="button">ثبت نام
                                        </button>
                                        @csrf
                                    </div>
                                    <div class="form-footer">
                ...
                <form id="registerForm" action="{{route('userRegister')}}" method="post">
                    ...
                    <div class="form-group">
                        <input required="" name="name" type="text" class="form-control"
                               placeholder="نام" id="name">
                        <span class="error_input" id="nameError"></span>
                    </div>
                    <div class="form-group">
                        <input required="" name="family" type="text" class="form-control"
                               placeholder="نام خانوادگی" id="family">
