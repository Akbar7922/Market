...
//            Add Address To User Addresses
            ...
            $user_address = json_decode(\Auth::user()->addresses)[$request->address_list];
    ...
    public function callback()
    {
        ...
        try {
            if (request()->status == 'NOK'){
                $transactionService->updateStatus(request()->Authority , 4,
                ...
                $transactionService->updateStatus(request()->Authority, 3,
             ...
             **/
            $transactionService->updateStatus(request()->transactionId , 4,
